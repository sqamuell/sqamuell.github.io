...
function NavBar() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-opacity-80 bg-white", children: [
    /* @__PURE__ */ jsx("div", { className: "fixed left-3 top-3 text-2xl w-2", children: /* @__PURE__ */ jsx("p", { className: `hover:text-yellow-500 cursor-pointer select-none ${isVisible ? "hidden" : "show"}`, onClick: handleClick, children: "☰" }) }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: `transform select-none top-0 p-4 left-0 w-auto bg-white fixed h-screen md:h-[97vh] m-0 md:m-4 md:mt-[1.5vh] border-2 border-neutral-250
        ...
        children: [
          /* @__PURE__ */ jsxs("ul", { className: "hover:*:*:text-yellow-500", children: [
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "./projects/itech-research-pavilion", children: "ITECH Research Pavilion" }) }),
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "./projects/cloud-sketch", children: "Cloud Sketch" }) }),
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "./projects/drawings", children: "Drawings" }) })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "fixed top-4 select-none right-7 md:-right-7 hover:text-yellow-500 cursor-pointer font-bold", onClick: handleClick, children: "✕" })
        ]
      }
    )
  ] });
...
function Album({ cover, location, index, targetOffset, setTargetOffset, hovered, setHovered, op, filters, filter_tags }) {
  ...
  return /* @__PURE__ */ jsxs(
    "mesh",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("meshStandardMaterial", { map: cover, toneMapped: false, transparent: true, alphaMap: useLoader(TextureLoader, "/mats/homepage/cover-alpha-map-sm.jpg"), opacity: op })
      ]
    }
  );
}
function Scene({ setCurCenter, filters }) {
  const navigate = useNavigate();
  ...
  useFrame(() => {
    ...
    let opacityDistance = 1 - op.current;
    let opacitySpeed = easeOutSine(opacityDistance);
    op.current += opacitySpeed * 0.04;
    if (op.current > 1)
      op.current = 1;
    setRenderTrigger((renderTrigger2) => !renderTrigger2);
  });
...
const FilterSelector = ({ category, setFilter }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("p", { className: `text-right cursor-pointer text-neutral-600 ${selected ? "hidden" : "block"}`, children: [
          " ☐ ",
          category.charAt(0).toUpperCase() + category.slice(1),
          " "
        ] }),
        /* @__PURE__ */ jsxs("p", { className: `text-right cursor-pointer text-black ${selected ? "block" : "hidden"}`, children: [
          " ☒ ",
          category.charAt(0).toUpperCase() + category.slice(1),
          " "
        ] })
...
const AlbumSelector = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `absolute w-screen h-[85vh] md:h-screen left-0 top-0 animate-fade ${grab ? "cursor-grabbing" : "cursor-grab"}`, onMouseDown: () => setGrab(true), onMouseUp: () => setGrab(false), children: [
    /* @__PURE__ */ jsx(
      Canvas,
      {
        linear: true,
        children: /* @__PURE__ */ jsxs(Suspense, { fallback: /* @__PURE__ */ jsx(Loader, {}), children: [
          ...
          /* @__PURE__ */ jsxs(
            Html,
            {
              ...
              zIndexRange: [0, 0],
              children: [
                /* @__PURE__ */ jsx("h1", { className: "select-none absolute left-1/2 top-[21vh] md:top-[20vh] -translate-x-1/2 text-nowrap", children: projects[curCenter].name.replace(/-/g, " ") }),
                /* @__PURE__ */ jsx("h2", { className: "select-none absolute left-1/2 top-[24.5vh] md:top-[23vh] -translate-x-1/2", children: projects[curCenter].year }),
                /* @__PURE__ */ jsxs("p", { className: "text-sm pointer-events-none md:text-base select-none	absolute left-1/2 top-[28.5vh] md:top-[26vh] -translate-x-1/2 w-80 text-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 w-2/3 absolute top-0 right-0 text-nowrap hidden md:flex flex-wrap justify-end text-neutral-600", children: [
      /* @__PURE__ */ jsx(FilterSelector, { category: "computational design", setFilter }),
      "|",
      /* @__PURE__ */ jsx(FilterSelector, { category: "digital fabrication", setFilter }),
      "|",
      /* @__PURE__ */ jsx(FilterSelector, { category: "artificial intelligence", setFilter }),
      "|",
      /* @__PURE__ */ jsx(FilterSelector, { category: "robotics", setFilter }),
      "|",
      /* @__PURE__ */ jsx(FilterSelector, { category: "software development", setFilter }),
      "|",
      /* @__PURE__ */ jsx(FilterSelector, { category: "architecture", setFilter })
    ] })
  ] });
};
const AlbumSelector$1 = AlbumSelector;
const stylesheet = "/assets/tailwind-CboeuT3c.css";
const links = () => [
...
function conversationalFloorPlans() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "A robust, transparent, and steerable AI agent system & interface for the design of floor plans. A collaboration with Cornelius Carl and Arindam Katoch." }),
    /* @__PURE__ */ jsx("br", {}),
...
function CyberneticField() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "Flattening the depth image of a three-dimensional space to the projector plane with a Kinect, the algorithm captures objects and actors in the scene. From these environment elements, contour information is extracted and used to recalculate vector directions and amplitudes within the field. The points are then affected by the change in vectors, reaching many states of disorder in the process of restabilizing themselves." }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("img", { alt: "", className: "w-1/4", src: "/mats/cybernetic_field/vectorfield.png" }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "Balance will always restore itself and the system will return to stability, always in a new fashion. Throughout the entire process, human actors are motivated to interact with the system, affect the pattern in the vector field, and have agency to be creative with a series of experimental different movements." }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("img", { alt: "", src: "/mats/cybernetic_field/process_1.png" }),
...
function HyperHydration$2() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("table", { className: "hidden md:block", children: /* @__PURE__ */ jsxs("tbody", { children: [
      /* @__PURE__ */ jsxs("tr", { className: "*:w-1/4", children: [
      ...
      /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("td", { children: "None: 17,396" }),
        /* @__PURE__ */ jsx("td", { children: "RBFOpt: 15,849" }),
        /* @__PURE__ */ jsx("td", { children: "CMAE-S: 15,863" }),
        /* @__PURE__ */ jsx("td", { children: "Random: 16,004" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("table", { className: "block md:hidden", children: /* @__PURE__ */ jsxs("tbody", { children: [
      /* @__PURE__ */ jsxs("tr", { className: "*:w-1/2", children: [
        /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("img", { alt: "", id: "12", src: "/mats/water_sports/hh_normal.gif" }) }),
        /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("img", { alt: "", id: "13", src: "/mats/water_sports/hh_rbf_opt.gif" }) })
      ] }),
      /* @__PURE__ */ jsxs("tr", { children: [
...
function WaxFlamingos() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "Using a found-object with an off-balance supporting location, a method was devised to incrementally add wax with the aim of positioning the object's Center Of Mass above a support location and bring the object into balance." }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "COMING SOON" })
  ] });
}
...
function HyperHydration$1() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsxs("p", { children: [
      "This p5.js sketch was a personal attempt to algorthimically capture the varied movement of clouds. It uses non-linear mapping of simplex noise to create both the arrangement and the drift of the clouds. Check out the ",
      /* @__PURE__ */ jsx(Link, { className: "underline hover:text-yellow-500", to: "https://editor.p5js.org/sqamuel/sketches/-uHONRpZg", rel: "noopener noreferrer", target: "_blank", children: "script" }),
      " (press ►) if you would like to see the procedural variety output by the algorithm."
    ] }),
    /* @__PURE__ */ jsx("br", {}),
...
function Honeycomb() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsxs("video", { className: "hidden md:block", controls: true, children: [
      /* @__PURE__ */ jsx(
        "source",
        {
    ...
    /* @__PURE__ */ jsxs("video", { className: "block md:hidden", controls: true, children: [
      /* @__PURE__ */ jsx(
        "source",
        {
...
function Misc() {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { children: "Drawings (2018)" }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "These are some charcoal and pastel drawings that I created during my frist-year drawing class in architecture school. Please enjoy." }),
    /* @__PURE__ */ jsx("br", {}),
...
function HyperHydration() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsxs("p", { children: [
      "This series of p5.js scripts is a study of the natural system of droplets on a smooth surface (e.g. marble). The motion of this system is emergent from the behaviors of each of individual droplet and the continual addition of agents to the environment. Check out the ",
      /* @__PURE__ */ jsx(Link, { className: "underline hover:text-yellow-500", to: "https://editor.p5js.org/sqamuel/sketches/O5TDu6eHo", rel: "noopener noreferrer", target: "_blank", children: "script" }),
      " (press ►) if you would like to see the procedural variety output by the algorithm."
    ] }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("img", { className: "m-auto md:w-7/12", src: "/mats/droplets/figure-ground.gif" }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("p", { children: "A droplet is defined by its mass, location, and three behaviors. (1) A gravity force behavior induced when it has a certain mass. (2) A spawn additional droplet behavior induced by movement. And (3) a merging behavior induced when coming in contact with another droplet. While each inidivual droplet has no systematic outcome, the summation of them in an enviornment results in the emergent system shown in the surrounding gifs." }),
    /* @__PURE__ */ jsx("br", {}),
...
function Container() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "absolute h-screen w-screen overflow-clip", children: [
    /* @__PURE__ */ jsx("div", { className: `absolute h-screen w-screen bg-white bg-opacity-10 backdrop-grayscale cursor-alias`, onClick: () => exit() }),
    /* @__PURE__ */ jsxs("div", { className: `absolute left-1/2 -translate-x-1/2 rounded-md mt-0 md:mt-[2.5vh] transition-all ease-out duration-500 ${isVisible ? "translate-y-0" : "translate-y-[100vh]"}
      ...
      /* @__PURE__ */ jsx("p", { className: "fixed right-3 top-3 md:-right-8 md:top-2 hover:text-yellow-500 cursor-pointer font-bold", onClick: () => exit(), children: "✕" })
    ] })
  ] });
}
...
const routes = {
  ...
  "routes/projects.itech-research-pavilion": {
    id: "routes/projects.itech-research-pavilion",
    parentId: "routes/projects",
    path: "itech-research-pavilion",
    index: void 0,
    caseSensitive: void 0,
    module: route2
  },
